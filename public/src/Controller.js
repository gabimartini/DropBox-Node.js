class Controller {
    ...
    connectFirebase(){
        ...
        let firebaseConfig = {
        apiKey: "AIzaSyDwZFgx5kWL-7xcH45vxtvC9AqQu0ANLLE",
        authDomain: "clone-dropbox.firebaseapp.com",
        databaseURL: "https://clone-dropbox.firebaseio.com",
        projectId: "clone-dropbox",
        storageBucket: "clone-dropbox.appspot.com",
        messagingSenderId: "802372293594",
        appId: "1:802372293594:web:068a151ae28a10cf8d26e3",
        measurementId: "G-KK5FB4ZQ8H"
      };
      // Initialize Firebase
        ...
        return new Promise((resolve, reject) => {
            ...
            folderRef.on('value', snapshot => {
                ...
                if (snapshot.exists()) {
                    ...
                    this.getFirebaseRef('Martini').child(key).remove();
    ...
    formatTimeToHuman(duration){
        ...
        if (hours > 0) {
            return `${hours} hours, ${minutes} minutes e ${seconds} seconds`;
        }
